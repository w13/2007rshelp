...
?>
<div class="boxtop">Zybez Uploader: Viewing Full Image</div>
<div class="boxbottom" style="padding: 6px 24px; text-align: center;">
<img src="http://www.runescapetop.com/up/images/<?=$image?>" />

<div style="padding: 10px;font-size:1.5em;"><a href="http://www.runescapetop.com/upload/">Go to the Zybez Uploader</a></div>
</div>
<?php
end_page();
?>