...
&raquo; <a href="guilds.php">Runescape Guild Guides</a> &raquo; <u><?php echo $info['name']; ?></u></div>
<hr class="main" noshade="noshade" />
...
<?php
  ...
  echo '<tr><td style="border-bottom: 1px solid #000; border-right: 1px solid #000;border-top:1px solid #000;">Author: <b>' . $info['author'] . '</b></td>'
?>  
 </tr>
</table>
<br />
