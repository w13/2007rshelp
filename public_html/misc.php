...
?>
<div class="boxtop">OSRS RuneScape Miscellaneous Guides</div><div class="boxbottom" style="padding-left: 24px; padding-top: 6px; padding-right: 24px;">
<a name="top"></a>
<?php
if(empty($id))
 {
?>
<div style="margin:1pt; font-size:large; font-weight:bold;">&raquo; Runescape Miscellaneous Guides</div>
...
&raquo; <a href="misc.php">OSRS RuneScape Miscellaneous Guides</a> &raquo; <u><?php echo htmlspecialchars($info['name']); ?></u></div>
<hr class="main" noshade="noshade" />
