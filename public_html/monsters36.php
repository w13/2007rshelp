...
<div style="margin:1pt; font-size:large; font-weight:bold;">&raquo; <a href="<?=$_SERVER['SCRIPT_NAME']?>">2007 RuneScape Monsters and NPC Database</a></div>
...
$idrops = explode('[,]',$info['i_drops']);
  ...
  //-- Calculator -->
	...
	if($info['raredrop'] == 1) {
 	echo '<tr>';
	echo '<td valign="top">Rare Drops:</td><td>
	Law rune (45), Uncut sapphire, Coins (3-3000), Adamant javelin (20), Death rune (45), Uncut ruby, Chaos talisman, Rune javelin (5), Nature rune (67), Uncut emerald, Nature talisman, Steel arrow (150), Uncut diamond, Loop half of key, Rune 2h sword, Rune arrow (42), Dragonstone, Tooth half of key, Rune battleaxe, Runite bar, Rune sq shield, Silver bar (100), Rune kiteshield, Dragon med helm, Rune spear, Dragon spear, Shield left half</td></tr>'; 
	}
