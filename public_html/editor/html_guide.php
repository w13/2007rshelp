<?php
require('backend.php');
start_page(1,'The Guide to Using HTML on OSRS RuneScape Help');
?>
...
&raquo; <u>The Guide to Using HTML on OSRS RuneScape Help</u></div>
...
<tr><td class="tablebottom">margin</td><td class="tablebottom">auto<br />#px<br />#em</td><td class="tablebottom">This is good for centering tables.  <span style="font-family:Courier New;">margin:0 auto;</span> will center objects.  That's pretty much the only practical use of this property on OSRS RuneScape Help. You can pad just certain sides of an opject just like with the padding property.</td></tr>
...
<li>On links, always put <span style="font-family:Courier New;">title="OSRS RuneScape Help's ______ Guide"</span> and on images always put <span style="font-family:Courier New;">alt="OSRS RuneScape Help's Image of ______"</span>.  It increases search term density and the <span style="font-family:Courier New;">alt</span> attribute is required for valid xHTML anyway.</li>
