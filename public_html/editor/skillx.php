...
if ($_GET['act'] == 'add') {
	...
	if ($_GET['reload'] != 'yes') header('Location: '.htmlspecialchars($_SERVER['PHP_SELF']));
...
if (mysqli_num_rows($query) == 0) {
	...
	while ($info = $db->fetch_array($query)) {
		echo '<tr><td class="tablebottom">'.$info['rsname'].'</td><td class="tablebottom"><a href="/community/index.php?showuser='.$info['rscid'].'">'.$info['rscname'].'</a></td><td class="tablebottom">'.$info['team'].'</td><td class="tablebottom"><a href="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=delete&name='.$info['rsname'].'" title="Delete"><img src="/img/calcimg/a_red.PNG" alt="delete"></a></tr>';
	}
}
...
echo '<br /><br /><table style="border-left: 1px solid #000;margin:0 12.5%" width="75%" cellpadding="1" cellspacing="0"><tr><th class="tabletop">Update Experience</th></tr>'
	.'<tr><td class="tablebottom"><form method="post" action="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=start"><input type="submit" value="Update Start XP" /></form><br /><br /><form method="post" action="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=end"><input type="submit" value="Update Current/End XP" /></form></td></tr></table>';
...
<form method="post" action="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=add">
...
echo '<br /><br /><table style="border-left: 1px solid #000;margin:0 12.5%" width="75%" cellpadding="1" cellspacing="0"><tr><th class="tabletop">Delete All Contestants</th></tr>'
	.'<tr><td class="tablebottom"><form method="post" action="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=deleteall"><input type="submit" value="Delete All Contestants" /></form></td></tr></table>';
...
echo '<br /><br /><table style="border-left: 1px solid #000;margin:0 12.5%" width="75%" cellpadding="1" cellspacing="0"><tr><th class="tabletop">Start Time</th></tr>'
	.'<tr><td class="tablebottom"><form method="post" action="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=starttime"><input name="time" type="text" value="'.$starttime.'" size="30" style="text-align:center;" /> <input type="submit" value="Update" /></form></td></tr></table>';
...
echo '<br /><br /><table style="border-left: 1px solid #000;margin:0 12.5%" width="75%" cellpadding="1" cellspacing="0"><tr><th class="tabletop">End Time</th></tr>'
	.'<tr><td class="tablebottom"><form method="post" action="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=settime"><input name="time" type="text" value="'.$endtime.'" size="30" style="text-align:center;" /> <input type="submit" value="Update" /></form></td></tr></table>';
...
echo '<br /><br /><table style="border-left: 1px solid #000;margin:0 12.5%" width="75%" cellpadding="1" cellspacing="0"><tr><th class="tabletop">RSC Topic ID</th></tr>'
	.'<tr><td class="tablebottom"><form method="post" action="'.htmlspecialchars($_SERVER['PHP_SELF']).'?act=settopic"><input name="topic" type="text" value="'.$topic.'" size="30" style="text-align:center;" /> <input type="submit" value="Update" /></form></td></tr></table>';
