  ...
  while($info = $db->fetch_array($query))
   {
    ...
    echo '<td class="tablebottom"><a href="?id=' . $info['id'] . '">' . $info['name'] . '</a></td>';
    echo '<td class="tablebottom">' . $info['type'] . '</td>';
    echo '<td class="tablebottom">' . $info['author'] . '</td>';
    echo '</tr>';
   } 
?>
</table>
...
&raquo; <a href="dungeonmaps.php">Runescape Dungeon Maps</a> &raquo; <u><?php echo $info['name'];?></u></div>
<hr class="main" noshade="noshade" />
...
<?php
  ...
  echo '<tr><td style="border-bottom: 1px solid #000000; border-right: 1px solid #000000">Mapped By: <b>' . $info['author'] . '</b></td>'
?>  
 </tr>
</table>
<br />
